...
$\Sigmacr \approx 4.82$~kg\,m$^{-2}$ for these distances):
\begin{align*}
    \theta_s &= r_s / \Dd \approx 67.8'' \,, \\
    \kappa_s &= 2\rho_s\, r_s / \Sigmacr \approx 0.41 \,.
\end{align*}
...
$x_t \approx 0.109$, so:
\begin{equation*}
    \thetaE = x_t\, \theta_s \approx 0.109 \times 67.8'' \approx 7.4'' \,.
\end{equation*}
...
definition):
\begin{equation*}
    M(\thetaE) \approx \pi\,(900~\text{Mpc} \times 7.4'' \times
    4.848\ee{-6})^2 \times 4.82~\text{kg\,m}^{-2}
    \approx 7.5\ee{12}\,\Msun \,.
\end{equation*}

\textbf{(d)} The fraction of the total virial mass within $\thetaE$:
\begin{equation*}
    \frac{M(\thetaE)}{M_{200}}
    \approx \frac{7.5\ee{12}}{5\ee{14}} \approx 0.015 \,.
\end{equation*}
About $1.5\%$ of the virial mass lies inside the Einstein radius.
The Einstein radius corresponds to a physical radius
$R_E = \Dd \thetaE \approx 32$~kpc, which is only $\sim 2\%$ of
...
$\thetaE \approx 7.4''$ (this cluster), the tangential magnification is
...
with $\Dds/\Ds = 1400/1750 = 0.8$ (using
...
\begin{align*}
    ...
    \thetaE = 4\pi(250/2.998\ee{5})^2 \times 0.8
    \approx 6.99\ee{-6}~\text{rad} \approx 1.44'' \,. \\
    \text{Group: } \sigma_v &= 500~\text{km/s}, \quad
    \thetaE = 4\pi(500/2.998\ee{5})^2 \times 0.8
    \approx 2.80\ee{-5}~\text{rad} \approx 5.77'' \,. \\
    \text{Cluster: } \sigma_v &= 1200~\text{km/s}, \quad
    \thetaE = 4\pi(1200/2.998\ee{5})^2 \times 0.8
    \approx 1.61\ee{-4}~\text{rad} \approx 33.2'' \,.
\end{align*}
...
\begin{align*}
    M(\thetaE)^{\text{galaxy}} &\approx 2.9\ee{11}\,\Msun \,, \\
    M(\thetaE)^{\text{group}} &\approx 4.6\ee{12}\,\Msun \,, \\
