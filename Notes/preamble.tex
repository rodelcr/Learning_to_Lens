...
% Two link modes controlled by \iflocallinks:
%   LOCAL (default when building from repo): relative paths that open actual files
%   GITHUB (for published PDFs on website): absolute GitHub URLs
%
% To build the GitHub-linked version:  \def\githublinks{}\input{main.tex}
% To build the local-linked version:   pdflatex main.tex  (default)
\newif\iflocallinks
\locallinkstrue  % default: local relative paths
\ifdefined\githublinks
    \locallinksfalse
\fi
% Usage: \mathlink{01a_Special_Relativity/lorentz_transforms.wl}{Lorentz transform script}
\iflocallinks
    \newcommand{\mathlink}[2]{\href{run:../Mathematica/#1}{\texttt{#2}}}
    \newcommand{\solnlink}[2]{\href{run:../Solutions/#1}{\texttt{#2}}}
\else
