...
% Two link modes:
%   LOCAL (default): file:// URLs that open files directly on this machine
%   GITHUB (for website): absolute GitHub URLs
%
% To build the GitHub-linked version:  \def\githublinks{}\input{main.tex}
% To change the local repo path, edit \localrepo below.
\newcommand{\localrepo}{/Users/rosador/Documents/Learning_to_Lens}
%
...
\else
    \newcommand{\mathlink}[2]{\href{file://\localrepo/Mathematica/#1}{\texttt{#2}}}
    \newcommand{\solnlink}[2]{\href{file://\localrepo/Solutions/#1}{\texttt{#2}}}
\fi
