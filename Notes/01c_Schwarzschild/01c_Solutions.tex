...
% ----- Exercise 1.1 -----
\subsection*{Exercise~\ref{ex:verify_vacuum}: Verify $R_{\mu\nu} = 0$ for Schwarzschild}
...
% ----- Exercise 1.2 -----
\subsection*{Exercise~\ref{ex:kretschmann}: Kretschmann Scalar}
...
% ----- Exercise 1.4 -----
\subsection*{Exercise~\ref{ex:grav_redshift_calc}: Gravitational Redshift from a Neutron Star}
...
% ----- Exercise 1.5 -----
\subsection*{Exercise~\ref{ex:flamm_derive}: Flamm's Paraboloid}
