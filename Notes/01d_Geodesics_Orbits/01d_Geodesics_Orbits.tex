...
(Carroll eq.~5.70; Congdon \& Keeton Sec.~3.3.3, prose after eq.~3.86):
\begin{equation}
...
\begin{equation}
    \Delta\phi_{\mathrm{Mercury}} = 5.02 \times 10^{-7}~\text{rad/orbit}
    = 0.104''\text{/orbit} = 43.0''\text{/century} \,.
