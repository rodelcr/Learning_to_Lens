...
\begin{equation*}
    ...
    = \left(\frac{3L^2}{r^4} - \frac{12L^2}{r^5}\right)\bigg|_{r=3}
...
\begin{itemize}
    \item \textbf{Stable circular orbit} (minimum of $V_{\mathrm{eff}}$):
          $r_+ = 12$,\quad $V_{\mathrm{eff}}(12) = -1/12 + 16/288 - 16/1728 = -1/27 \approx -0.0370$
    \item \textbf{Unstable circular orbit} (maximum of $V_{\mathrm{eff}}$):
          $r_- = 4$,\quad $V_{\mathrm{eff}}(4) = -1/4 + 16/32 - 16/64 = -0.25 + 0.5 - 0.25 = 0$
