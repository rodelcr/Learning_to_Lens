...
field equation (Carroll eq.~1.5, in units with $c = 1$):
\begin{equation}
...
signature (Carroll Sec.~1.3, pp.~12--14).
...
classic relativistic effects (Carroll Sec.~1.3; Congdon \& Keeton
Sec.~3.1.2).  In each case the derivation is a single substitution:
\begin{itemize}
...
see also Carroll eq.~1.17), giving
