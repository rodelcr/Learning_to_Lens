...
% --- Title ---
\title{
    % The title block must stay under \textheight (650.4pt): report.cls wraps
    % \maketitle in \null\vfil ... \vfil\null, so any overflow breaks at a \vfil
    % and emits a stray page-number-only page (or a blank page before the title).
    % The instructor edition adds ~25pt here, so keep >=25pt of slack.
    \vspace{-2cm}
    ...
    % Keep every \\ INSIDE this \small group, including the trailing one.  In a
    % center environment \\ implies \par, and a paragraph's interline glue comes
    % from the \baselineskip in force at its \par.  report.cls sets \@title in
    % \LARGE, so any \\ left outside the brace breaks at \LARGE's ~22pt instead
    % of \small's 13.6pt --- across these entries that adds ~80pt and pushes the
    % block past \textheight, which makes \maketitle's \null\vfil ... \vfil\null
    % break at a \vfil and emit a stray page.
    {\small
    P.~Schneider, J.~Ehlers \& E.~E.~Falco, \textit{Gravitational Lenses} (1992) \\
    R.~Narayan \& M.~Bartelmann, \textit{Lectures on Gravitational Lensing} (1997) \\
    A.~O.~Petters, H.~Levine \& J.~Wambsganss, \textit{Singularity Theory and Gravitational Lensing} (2001) \\
    S.~Carroll, \textit{Spacetime and Geometry} (2004) \\
    A.~B.~Congdon \& C.~R.~Keeton, \textit{Principles of Gravitational Lensing} (2018) \\
    M.~Meneghetti, \textit{Introduction to Gravitational Lensing} (2021) \\
    P.~Saha, D.~Sluse, J.~Wagner \& L.~L.~R.~Williams, \textit{Essentials of Strong Gravitational Lensing} (2024) \\
    P.~Schneider, C.~S.~Kochanek \& J.~Wambsganss, \textit{Gravitational Lensing: Strong, Weak and Micro} (2006)
    \\[0.5cm]}
    \ifsolutions
...
\begin{itemize}[nosep]
    ...
    \item P.~Schneider, C.~S.~Kochanek \& J.~Wambsganss, \textit{Gravitational
          Lensing: Strong, Weak and Micro}, Saas-Fee Advanced Course~33
          (Springer, 2006)
\end{itemize}

\medskip
\noindent
Full bibliographic details for these and all works cited in the text appear
in the \textbf{References} at the end of this document.
...
\ifsolutions\input{01a_Special_Relativity/01a_Solutions}\fi

\include{01b_Differential_Geometry/01b_Differential_Geometry}
\ifsolutions\input{01b_Differential_Geometry/01b_Solutions}\fi

\include{01c_Schwarzschild/01c_Schwarzschild}
\ifsolutions\input{01c_Schwarzschild/01c_Solutions}\fi

\include{01d_Geodesics_Orbits/01d_Geodesics_Orbits}
\ifsolutions\input{01d_Geodesics_Orbits/01d_Solutions}\fi

\include{01e_Linearized_Gravity/01e_Linearized_Gravity}
\ifsolutions\input{01e_Linearized_Gravity/01e_Solutions}\fi
...
\ifsolutions\input{02_Light_Deflection/02_Solutions}\fi

\include{03_Cosmological_Distances/03_Cosmological_Distances}
\ifsolutions\input{03_Cosmological_Distances/03_Solutions}\fi

\include{04_Lens_Equation/04_Lens_Equation}
\ifsolutions\input{04_Lens_Equation/04_Solutions}\fi
\include{05_Magnification_Convergence_Shear/05_Magnification_Convergence_Shear}
\ifsolutions\input{05_Magnification_Convergence_Shear/05_Solutions}\fi

\include{06_Fermat_Time_Delays/06_Fermat_Time_Delays}
\ifsolutions\input{06_Fermat_Time_Delays/06_Solutions}\fi
...
\ifsolutions\input{07_Axisymmetric_Models/07_Solutions}\fi

\include{08_Elliptical_Models_Caustics/08_Elliptical_Models_Caustics}
\ifsolutions\input{08_Elliptical_Models_Caustics/08_Solutions}\fi
\include{09_Galaxy_Lensing_Applications/09_Galaxy_Lensing_Applications}
\ifsolutions\input{09_Galaxy_Lensing_Applications/09_Solutions}\fi

\include{10_Cluster_Lensing/10_Cluster_Lensing}
\ifsolutions\input{10_Cluster_Lensing/10_Solutions}\fi

% =============================================================================
% Part IV: Statistical, Weak, and Micro Lensing
% =============================================================================
\part{Statistical, Weak, and Micro Lensing}

\include{11_Lensing_Statistics/11_Lensing_Statistics}
\ifsolutions\input{11_Lensing_Statistics/11_Solutions}\fi

\include{12_Weak_Lensing/12_Weak_Lensing}
\ifsolutions\input{12_Weak_Lensing/12_Solutions}\fi

\include{13_Microlensing/13_Microlensing}
\ifsolutions\input{13_Microlensing/13_Solutions}\fi
