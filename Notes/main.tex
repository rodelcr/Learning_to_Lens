...
\title{
    ...
    {\normalsize Based on the published works of} \\[0.2cm]
    {\normalsize
    S.~Carroll;
    A.~B.~Congdon \& C.~R.~Keeton;
    R.~Narayan \& M.~Bartelmann;} \\
    {\normalsize
    P.~Saha, D.~Sluse, J.~Wagner \& L.~L.~R.~Williams;
    M.~Meneghetti;} \\
    {\normalsize
    P.~Schneider, J.~Ehlers \& E.~E.~Falco;
    A.~O.~Petters, H.~Levine \& J.~Wambsganss}
    \\[0.5cm]
    \ifsolutions
...
notebooks, drawing on the reference textbooks listed on the title page.
...
All physics content derives from the published textbooks and review articles
cited throughout, and all symbolic computations are verified by Mathematica.

\medskip
\noindent
The full source code, Mathematica notebooks, and build scripts are available
at: \url{https://github.com/rodelcr/Learning_to_Lens}
